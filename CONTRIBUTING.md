...
Welcome to `stdock` contributor's guide.
...
If you experience bugs or general issues with `stdock`, please have a look
...
You can help improve `stdock` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`stdock` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `stdock`'s files. While this mechanism can
...
```
conda create -n stdock python=3 six virtualenv pytest pytest-cov
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/stdock.git
   cd stdock
   ```
...
5. Install [pre-commit]:
   ...
   `stdock` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/stdock
[issue tracker]: https://github.com/<USERNAME>/stdock/issues
